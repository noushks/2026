{
 "cells": [
  {
   "cell_type": "markdown",
   "id": "3203dbc3-bb5d-4422-9d79-02c4cb2a8692",
   "metadata": {},
   "source": [
    "# Anoushka Mukherjee\n",
    "## Final Project\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 1,
   "id": "209dd017-b851-46da-bd52-21bb43b900fe",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "53bc7b8b-cb69-4eaf-9a0c-05d83fb36a87",
   "metadata": {},
   "source": [
    "---"
   ]
  ...
  {
   "cell_type": "markdown",
   "id": "4384f120-4abb-4233-b5f1-9ce830ef95cc",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 21,
   "id": "874646e0-5bc4-4326-8499-1339ec900508",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 22,
   "id": "3e2cea88-f5b7-47d5-93d0-6e5516278953",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  {
   "cell_type": "markdown",
   "id": "d618526d-5c92-4bfa-a316-61efebce132e",
   "metadata": {},
   "source": [
    "---"
   ]
  ...
  {
   "cell_type": "markdown",
   "id": "d47970ea-4a80-40a4-af5d-0d56f492df7e",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 16,
   "id": "b49e2fdb-4352-4176-bd7c-3bb45838bb17",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "   web1h  gender  web1h_clean  gender_clean\n",
      "0      1       1            1             1\n",
      "1      0       4            0             0\n",
      "2      3       7            0             0\n"
     ]
   ...
   "source": [
    ...
    "})\n",
    "#testing: \n",
    "s[\"web1h_clean\"] = clean_sm(s[\"web1h\"])\n",
    "s[\"gender_clean\"] = clean_sm(s[\"gender\"])\n",
    "\n",
    "print(s)"
   ]
  },
  {
   "cell_type": "markdown",
   "id": "7923a126-d1ed-4aa6-8432-ad279a59ebfc",
   "metadata": {},
   "source": [
    "---"
   ]
  ...
  {
   "cell_type": "markdown",
   "id": "88d1c665-6cc5-4dfb-a81e-afc8a18e01ad",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 24,
   "id": "cc593ec6-649e-48e3-8134-1352cec6da19",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  {
   "cell_type": "markdown",
   "id": "ce35eac2-aa24-449a-89fc-5bf594e390b7",
   "metadata": {},
   "source": [
    "---"
   ]
  ...
  {
   "cell_type": "markdown",
   "id": "03d781b6-ad80-4702-b963-fd4e1d86e600",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 25,
   "id": "45342c49-df7e-4f60-ba35-1e015665e4a9",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      ...
      "0     6.0        4.0       0        0       1  77.0\n",
      "1     5.0        3.0       0        0       0  59.0\n",
      "2     8.0        4.0       0        1       1  60.0\n",
      "3     8.0        8.0       0        0       0  73.0\n",
      "4     7.0        8.0       0        1       1  65.0\n"
     ]
    }
   ],
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "2699302b-0849-4c2d-bfab-608e42fdeeb8",
   "metadata": {},
   "source": [
    "---"
   ]
  ...
  {
   "cell_type": "markdown",
   "id": "b4bbef96-b866-4775-9720-8ed05fca6462",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 28,
   "id": "37963374-11b5-49f8-826e-34e5ceec58ca",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  {
   "cell_type": "markdown",
   "id": "9fc7dae7-7f5d-4d98-9ddd-3d61ca9bddd2",
   "metadata": {},
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "a329d3db-910f-4caf-b6a4-a3b2aa42fb37",
   "metadata": {},
   "source": [
    "---"
   ]
  ...
  {
   "cell_type": "markdown",
   "id": "315ac8ce-b7ee-4e67-b228-123d217a3bd3",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 32,
   "id": "5fb9386d-0d90-49c7-a098-468b3afdf416",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  {
   "cell_type": "markdown",
   "id": "b071488e-3d3a-4832-8e9e-ce775286ce18",
   "metadata": {},
   "source": [
    "---"
   ]
  ...
  {
   "cell_type": "markdown",
   "id": "0f379cf8-b129-42ac-8d63-e1f0ed9f558b",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 34,
   "id": "e33b8393-8d29-44a3-b31d-47027826809e",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  {
   "cell_type": "markdown",
   "id": "69d88351-59a6-46ab-a441-62c96026c7e6",
   "metadata": {},
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "e6efffb4-71f4-4d56-8af1-af54ca1bd163",
   "metadata": {},
   "source": [
    "---"
   ]
  ...
  {
   "cell_type": "markdown",
   "id": "51cc1984-3fc0-45fa-8c2b-d8d61deed2a2",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 37,
   "id": "d015e22e-dd58-4549-8f37-c94c814617d8",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      ...
      "Actual_Negative (0)                     108                      60\n",
      "Actual_Positive (1)                      21                      63\n"
     ]
    }
   ],
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "5cde96ac-1b97-40a3-a933-d1f99a0735d9",
   "metadata": {},
   "source": [
    "---"
   ]
  ...
  {
   "cell_type": "markdown",
   "id": "7a80e445-708e-4f1c-8012-cd871123d47f",
   "metadata": {},
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "c07f5f4b-2292-44b7-9ea6-2a1a62f1291a",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 38,
   "id": "b6f8bf4f-958a-4442-9656-fc4a3060e377",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  {
   "cell_type": "markdown",
   "id": "a0d92adf-1fd1-4221-89bd-46914e908162",
   "metadata": {},
   "source": [
    "---"
   ]
  ...
  {
   "cell_type": "markdown",
   "id": "fdc31691-bc3b-4b3b-8dc0-cba269817a1c",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 39,
   "id": "60b2a197-1f00-4807-8f67-6e5d402f0bb9",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "Probability Person A (age 42) uses LinkedIn: 0.6998\n",
      "Probability Person B (age 82) uses LinkedIn: 0.4433\n"
     ]
    },
    {
     "name": "stderr",
   ...
   "source": [
    ...
    "\n",
    "#Let's assume person A is 82 years old: \n",
  ...
  {
   "cell_type": "markdown",
   "id": "f4a1e119-de65-41d5-8c83-efb2f3c22c7e",
   "metadata": {},
   "source": [
    "---"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "1feb7170-e2aa-4987-a8b6-94087adcdc4d",
   "metadata": {},
   "outputs": [
    {
     "ename": "SyntaxError",
     "evalue": "invalid syntax (568366443.py, line 1)",
     "output_type": "error",
     "traceback": [
      "\u001b[0;36m  Cell \u001b[0;32mIn[2], line 1\u001b[0;36m\u001b[0m\n\u001b[0;31m    jupyter nbconvert --to script Programming2_FinalProject.ipynb\u001b[0m\n\u001b[0m            ^\u001b[0m\n\u001b[0;31mSyntaxError\u001b[0m\u001b[0;31m:\u001b[0m invalid syntax\n"
     ]
    }
   ],
   "source": [
    "jupyter nbconvert --to script Programming2_FinalProject.ipynb"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "0b863b50-035a-4cd5-8e5a-99e474281760",
   "metadata": {},
   "outputs": [],
   "source": []
  }
